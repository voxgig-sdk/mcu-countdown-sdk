...
API to find out when the next MCU film is releasing.

Learn more about MCU-Countdown at [github.com/DiljotSG/MCU-Countdown](https://github.com/DiljotSG/MCU-Countdown).
...
This SDK exposes the API as a small set of **semantic entities** — Api, Batman, Dcn and StarWar — that you
...
| **Batman** | The Batman entity (load). | `/batman` |
| **Dcn** | The Dcn entity (load). | `/dc` |
| **StarWar** | The StarWar entity (load). | `/star-wars` |
