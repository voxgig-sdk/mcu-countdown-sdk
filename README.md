...
This is an unofficial SDK for the MCU-Countdown public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/mcu-countdown` | `npm install @voxgig-sdk/mcu-countdown` |
| Python | `voxgig-sdk-mcu-countdown` | `pip install voxgig-sdk-mcu-countdown` |
| PHP | `voxgig-sdk/mcu-countdown` | `composer require voxgig-sdk/mcu-countdown` |
| Golang | `github.com/voxgig-sdk/mcu-countdown-sdk/go` | `go get github.com/voxgig-sdk/mcu-countdown-sdk/go` |
| Ruby | `voxgig-sdk-mcu-countdown` | `gem install voxgig-sdk-mcu-countdown` |
| Lua | `voxgig-sdk-mcu-countdown` | `luarocks install voxgig-sdk-mcu-countdown` |
