// Command McuCountdown-mcp is an MCP server exposing the McuCountdown
// SDK as MCP tools.
//
// Two tools are registered:
//
//	McuCountdown_list  — list records of an entity
//	McuCountdown_load  — load a single record of an entity
//
