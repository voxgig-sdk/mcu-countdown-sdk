...
// McuCountdown SDK clienttrack feature
...
class McuCountdownClienttrackFeature extends McuCountdownBaseFeature
{
    ...
    public function PostConstruct(McuCountdownContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'McuCountdown-SDK';
