...
// McuCountdown SDK timeout feature
...
class McuCountdownTimeoutFeature extends McuCountdownBaseFeature
{
    ...
    private function _with_timeout(McuCountdownContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(McuCountdownContext $_ctx, float $ms): void
    {
        $client = $this->client;
