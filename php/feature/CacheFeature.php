...
// McuCountdown SDK cache feature
...
class McuCountdownCacheFeature extends McuCountdownBaseFeature
{
    ...
    private function _through(McuCountdownContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
