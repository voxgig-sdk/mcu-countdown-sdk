...
class McuCountdownRbacFeature extends McuCountdownBaseFeature
{
    ...
    private function _required(McuCountdownContext $ctx): ?string
    {
    ...
    private function _reject(McuCountdownContext $ctx, string $required): void
    {
    ...
    private function _track(McuCountdownContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
