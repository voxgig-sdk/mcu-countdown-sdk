...
// McuCountdown SDK ratelimit feature
...
class McuCountdownRatelimitFeature extends McuCountdownBaseFeature
{
    ...
    private function _acquire(McuCountdownContext $ctx): void
    {
    ...
    private function _track(McuCountdownContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
