...
// McuCountdown SDK metrics feature
...
class McuCountdownMetricsFeature extends McuCountdownBaseFeature
{
    ...
    private function _record(McuCountdownContext $ctx, bool $ok): void
    {
