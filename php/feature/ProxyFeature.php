...
// McuCountdown SDK proxy feature
...
class McuCountdownProxyFeature extends McuCountdownBaseFeature
{
    ...
    public function init(McuCountdownContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (McuCountdownContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
