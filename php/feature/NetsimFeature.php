...
// McuCountdown SDK netsim feature
...
class McuCountdownNetsimFeature extends McuCountdownBaseFeature
{
    ...
    private function _simulate(McuCountdownContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(McuCountdownContext $ctx, array $applied): void
    {
        $client = $this->client;
