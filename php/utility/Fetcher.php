...
// McuCountdown SDK utility: fetcher

class McuCountdownFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; McuCountdownSDK/1.0)';
    ...
    public static function call(McuCountdownContext $ctx, string $fullurl, array $fetchdef): array
    {
