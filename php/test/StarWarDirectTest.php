...
class StarWarDirectTest extends TestCase
{
    public function test_direct_load_star_war(): void
    {
        $setup = star_war_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-star_war", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
