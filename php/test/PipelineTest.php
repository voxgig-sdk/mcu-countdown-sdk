...
// McuCountdown SDK pipeline test
//
...
{
    private static function utility(): McuCountdownUtility
    {
        return new McuCountdownUtility();
    }
    ...
    private static function ctx(array $over = []): McuCountdownContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new McuCountdownContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new McuCountdownOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof McuCountdownError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new McuCountdownOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = McuCountdownMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new McuCountdownOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = McuCountdownMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new McuCountdownOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = McuCountdownMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new McuCountdownSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = McuCountdownMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new McuCountdownResponse([]),
            'result' => new McuCountdownResult([]),
        ]);
        [, $err] = McuCountdownMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new McuCountdownSpec([]),
            'response' => null,
            'result' => new McuCountdownResult([]),
        ]);
        [, $err] = McuCountdownMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new McuCountdownSpec(['step' => 's']),
            'response' => new McuCountdownResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new McuCountdownResult([]),
        ]);
        [, $err] = McuCountdownMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new McuCountdownSpec(['step' => 's']),
            'response' => new McuCountdownResponse(self::resp(200, ['v' => 1])),
            'result' => new McuCountdownResult([]),
        ]);
        [, $err] = McuCountdownMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new McuCountdownSpec(['step' => 's']),
            'response' => new McuCountdownResponse(self::resp(200, ['v' => 2])),
            'result' => new McuCountdownResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        McuCountdownMakeResponse::call($ctx);
    ...
    {
        $preset = new McuCountdownResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new McuCountdownSpec([]),
            'response' => new McuCountdownResponse([]),
            'result' => new McuCountdownResult([]),
        ...
        [$got, $err] = McuCountdownMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new McuCountdownResult([])]);
        [, $err] = McuCountdownMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new McuCountdownSpec([]), 'result' => null]);
        [, $err] = McuCountdownMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new McuCountdownSpec(['step' => 's']),
            'result' => new McuCountdownResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new McuCountdownOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = McuCountdownMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new McuCountdownSpec(['step' => 's']),
            'result' => new McuCountdownResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new McuCountdownOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = McuCountdownMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new McuCountdownResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new McuCountdownSpec([]),
            'result' => new McuCountdownResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = McuCountdownMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = McuCountdownMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new McuCountdownError('boom', 'boom');
        $utility->fetcher = function (McuCountdownContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new McuCountdownSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = McuCountdownMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (McuCountdownContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = McuCountdownMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(McuCountdownResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        McuCountdownMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (McuCountdownContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new McuCountdownSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = McuCountdownMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new McuCountdownResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new McuCountdownSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = McuCountdownMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = McuCountdownMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = McuCountdownMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new McuCountdownResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, McuCountdownDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new McuCountdownResult(['ok' => false])]);
        $this->expectException(McuCountdownError::class);
        McuCountdownDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new McuCountdownResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', McuCountdownMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        McuCountdownMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new McuCountdownBaseFeature();
        $b = new McuCountdownBaseFeature();
        McuCountdownFeatureAdd::call($ctx, $a);
        McuCountdownFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): McuCountdownBaseFeature
    {
        $f = new McuCountdownBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        McuCountdownFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): McuCountdownContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new McuCountdownSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = McuCountdownPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        McuCountdownPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new McuCountdownResponse(['headers' => null]),
            'result' => new McuCountdownResult([]),
        ]);
        McuCountdownResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        McuCountdownResultBody::call($ctx);
