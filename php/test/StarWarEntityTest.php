...
class StarWarEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MCU_COUNTDOWN_TEST_STAR_WAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $star_war_ref01_data_dt0_load_result = Helpers::to_map(is_object($star_war_ref01_data_dt0_loaded) && method_exists($star_war_ref01_data_dt0_loaded, 'data_get') ? $star_war_ref01_data_dt0_loaded->data_get() : $star_war_ref01_data_dt0_loaded);
...
function star_war_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MCU_COUNTDOWN_TEST_STAR_WAR_ENTID");
