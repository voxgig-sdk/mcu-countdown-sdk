...
// McuCountdown SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (McuCountdownSDK::test)
...
{
    private const SDK_CLASS = 'McuCountdownSDK';
    ...
    private const SDK_BASE = 'mcucountdown_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mcucountdown_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
