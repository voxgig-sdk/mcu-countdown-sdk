...
class BatmanDirectTest extends TestCase
{
    public function test_direct_load_batman(): void
    {
        $setup = batman_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-batman", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
