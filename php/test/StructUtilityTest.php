...
// McuCountdown SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = McuCountdownOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(McuCountdownOmni::structfix($now, Struct::undef()))
                        !== json_encode(McuCountdownOmni::structfix($val, Struct::undef()))) {
