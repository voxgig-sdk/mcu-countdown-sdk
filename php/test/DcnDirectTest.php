...
class DcnDirectTest extends TestCase
{
    public function test_direct_load_dcn(): void
    {
        $setup = dcn_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-dcn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
