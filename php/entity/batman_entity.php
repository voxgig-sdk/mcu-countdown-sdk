...
// McuCountdown SDK Batman entity
...
class BatmanEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BatmanEntity($this->_client, $opts);
    }

    /**
     * @param Batman|array $args Batman data (assoc-array) to store.
     */
    ...
    /**
     * @return Batman|array The current Batman data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Batman fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Batman fields).
     */
    ...
    /**
     * Load a single Batman.
     *
     * @param BatmanLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BatmanLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Batman|array The loaded Batman as an assoc-array at the
