# McuCountdown PHP SDK



The PHP SDK for the McuCountdown API — an entity-oriented client using PHP conventions.
...
$client = McuCountdownSDK::test([
    "entity" => ["batman" => ["test01" => ["id" => "test01"]]],
]);

// Entity ops return the ENTITY (throws on error);
// call data_get() for the mock record.
$batman = $client->Batman()->load(["id" => "test01"]);
print_r($batman->data_get());
```
...
```
php/
├── mcucountdown_sdk.php          -- Main SDK class
...
The main class (`mcucountdown_sdk.php`) exports the SDK class
