...
function envOverride(m) {
    if ('TRUE' === process.env.MCU_COUNTDOWN_TEST_LIVE ||
        'TRUE' === process.env.MCU_COUNTDOWN_TEST_OVERRIDE) {
    ...
    m.MCU_COUNTDOWN_TEST_EXPLAIN = process.env.MCU_COUNTDOWN_TEST_EXPLAIN || m.MCU_COUNTDOWN_TEST_EXPLAIN;
    return m;
}
