...
(0, node_test_1.describe)('StarWarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.McuCountdownSDK({
    ...
    (0, node_test_1.test)('direct-load-star_war', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-star_war', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MCU_COUNTDOWN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.McuCountdownSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MCU_COUNTDOWN_TEST_STAR_WAR_ENTID'];
    ...
    const client = new __1.McuCountdownSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=StarWarDirect.test.js.map