...
(0, node_test_1.describe)('DcnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dcn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dcn', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MCU_COUNTDOWN_TEST_DCN_ENTID'];
...
//# sourceMappingURL=DcnDirect.test.js.map