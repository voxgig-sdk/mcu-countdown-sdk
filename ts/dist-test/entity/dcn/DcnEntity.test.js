...
(0, node_test_1.describe)('DcnEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let dcn_ref01_data = Object.values(setup.data.existing.dcn)[0];
        // LOAD
        const dcn_ref01_ent = client.Dcn();
        const dcn_ref01_match_dt0 = {};
        dcn_ref01_match_dt0.id = dcn_ref01_data.id;
        const dcn_ref01_data_dt0 = (await dcn_ref01_ent.load(dcn_ref01_match_dt0)).data();
        (0, node_assert_1.default)(dcn_ref01_data_dt0.id === dcn_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/dcn/DcnTestData.json');
    ...
    let idmap = transform(['dcn01', 'dcn02', 'dcn03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DcnEntity.test.js.map