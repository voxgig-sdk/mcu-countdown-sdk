...
(0, node_test_1.describe)('BatmanEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'batman.' + op, live))
                return;
        }
        ...
        let batman_ref01_data = Object.values(setup.data.existing.batman)[0];
        // LOAD
        const batman_ref01_ent = client.Batman();
        const batman_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(batman_ref01_data_dt0.id === batman_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/batman/BatmanTestData.json');
    ...
    let idmap = transform(['batman01', 'batman02', 'batman03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BatmanEntity.test.js.map