...
const testSeed = `map[string]any{"entity": map[string]any{"api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batman": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dcn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "star_war": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
