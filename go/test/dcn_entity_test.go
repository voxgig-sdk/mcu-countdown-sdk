...
func TestDcnEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		dcnRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.dcn")))
		...
		dcnRef01DataDt0LoadResult := core.ToMapAny(entityData(dcnRef01DataDt0Loaded))
...
func dcnBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MCU_COUNTDOWN_TEST_DCN_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MCU_COUNTDOWN_TEST_DCN_ENTID"])
