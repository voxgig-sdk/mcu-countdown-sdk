...
func NewDcnEntity(client *core.McuCountdownSDK, entopts map[string]any) *DcnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DcnEntity) GetName() string { return e.name }
...
func (e *DcnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DcnEntity) Deleted() bool {
	return e.deleted
}


func (e *DcnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDcnEntity(e.client, opts)
}

func (e *DcnEntity) Data(args ...any) any {
...
func (e *DcnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dcn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DcnEntity) DataTyped(data ...Dcn) Dcn {
	if len(data) > 0 {
		return typedFrom[Dcn](e.Data(asMap(data[0])))
	}
	return typedFrom[Dcn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dcn (all fields
// optional at the wire level).
func (e *DcnEntity) MatchTyped(match ...Dcn) Dcn {
	if len(match) > 0 {
		return typedFrom[Dcn](e.Match(asMap(match[0])))
	}
	return typedFrom[Dcn](e.Match())
}
...
func (e *DcnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DcnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DcnLoadMatch and returns an Dcn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DcnEntity) LoadTyped(reqmatch DcnLoadMatch, ctrl map[string]any) (Dcn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dcn{}, err
	}
	return typedFrom[Dcn](res), nil
}



func (e *DcnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DcnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DcnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DcnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DcnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
