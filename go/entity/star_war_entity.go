...
func NewStarWarEntity(client *core.McuCountdownSDK, entopts map[string]any) *StarWarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StarWarEntity) GetName() string { return e.name }
...
func (e *StarWarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StarWarEntity) Deleted() bool {
	return e.deleted
}


func (e *StarWarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStarWarEntity(e.client, opts)
}

func (e *StarWarEntity) Data(args ...any) any {
...
func (e *StarWarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *StarWarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StarWarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StarWarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StarWarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StarWarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StarWarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
