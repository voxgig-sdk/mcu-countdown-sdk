...
type BatmanEntity struct {
	name    string
	client  *core.McuCountdownSDK
...
func NewBatmanEntity(client *core.McuCountdownSDK, entopts map[string]any) *BatmanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BatmanEntity) GetName() string { return e.name }
...
func (e *BatmanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BatmanEntity) Deleted() bool {
	return e.deleted
}


func (e *BatmanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBatmanEntity(e.client, opts)
}

func (e *BatmanEntity) Data(args ...any) any {
...
func (e *BatmanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Batman; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BatmanEntity) DataTyped(data ...Batman) Batman {
	if len(data) > 0 {
		return typedFrom[Batman](e.Data(asMap(data[0])))
	}
	return typedFrom[Batman](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Batman (all fields
// optional at the wire level).
func (e *BatmanEntity) MatchTyped(match ...Batman) Batman {
	if len(match) > 0 {
		return typedFrom[Batman](e.Match(asMap(match[0])))
	}
	return typedFrom[Batman](e.Match())
}
...
func (e *BatmanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BatmanEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BatmanLoadMatch and returns an Batman. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BatmanEntity) LoadTyped(reqmatch BatmanLoadMatch, ctrl map[string]any) (Batman, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Batman{}, err
	}
	return typedFrom[Batman](res), nil
}



func (e *BatmanEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BatmanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BatmanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BatmanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BatmanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
