...
The Golang SDK for the McuCountdown API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/mcu-countdown-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/mcu-countdown-sdk=../path/to/github.com/voxgig-sdk/mcu-countdown-sdk
```
...
```
github.com/voxgig-sdk/mcu-countdown-sdk/
...
The root package (`github.com/voxgig-sdk/mcu-countdown-sdk`) re-exports everything needed
