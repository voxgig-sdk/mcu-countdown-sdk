...
// instead of `sdk.NewMcuCountdownSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *McuCountdownSDK  { return NewMcuCountdownSDK(nil) }
func Test() *McuCountdownSDK { return TestSDK(nil, nil) }
