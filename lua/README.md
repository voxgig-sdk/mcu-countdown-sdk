# McuCountdown Lua SDK



The Lua SDK for the McuCountdown API — an entity-oriented client using Lua conventions.
...
Create an instance: `local batman = client:Batman(nil)`
...
Create an instance: `local dcn = client:Dcn(nil)`
...
Create an instance: `local star_war = client:StarWar(nil)`
...
```
lua/
├── mcu-countdown_sdk.lua    -- Main SDK module
...
The main module (`mcu-countdown_sdk`) exports the SDK constructor
