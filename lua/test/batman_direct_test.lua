...
describe("BatmanDirect", function()
  it("should direct-load-batman", function()
    local setup = batman_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-batman", setup.live and "live" or "unit")
...
function batman_direct_setup(mockres)
