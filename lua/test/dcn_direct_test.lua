...
describe("DcnDirect", function()
  it("should direct-load-dcn", function()
    local setup = dcn_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dcn", setup.live and "live" or "unit")
...
function dcn_direct_setup(mockres)
