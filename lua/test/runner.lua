...
function runner.env_override(m)
  local live = runner.getenv("MCU_COUNTDOWN_TEST_LIVE")
  local override = runner.getenv("MCU_COUNTDOWN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MCU_COUNTDOWN_TEST_EXPLAIN")
