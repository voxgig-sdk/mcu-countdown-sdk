...
function runner.env_override(m)
  local live = runner.getenv("MCUCOUNTDOWN_TEST_LIVE")
  local override = runner.getenv("MCUCOUNTDOWN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MCUCOUNTDOWN_TEST_EXPLAIN")
