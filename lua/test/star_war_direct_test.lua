...
describe("StarWarDirect", function()
  it("should direct-load-star_war", function()
    local setup = star_war_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-star_war", setup.live and "live" or "unit")
...
function star_war_direct_setup(mockres)
