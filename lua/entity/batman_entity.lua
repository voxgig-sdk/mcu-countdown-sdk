...
local BatmanEntity = {}
BatmanEntity.__index = BatmanEntity


function BatmanEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BatmanEntity)
  self._name = "batman"
  self._client = client
...
function BatmanEntity:get_name()
  return self._name
end


function BatmanEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BatmanEntity.new(self._client, opts)
end
...
function BatmanEntity:mark_deleted()
  self._deleted = true
end


function BatmanEntity:deleted()
  return true == self._deleted
end


function BatmanEntity:data_set(args)
  if args ~= nil then
...
function BatmanEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BatmanEntity:match_set(args)
  if args ~= nil then
...
function BatmanEntity:match_get()
...
function BatmanEntity:stream(action, args, callopts)
...
function BatmanEntity:_run_op(ctx, post_done)
  local utility = self._utility
