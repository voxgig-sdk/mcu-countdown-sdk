...
local StarWarEntity = {}
StarWarEntity.__index = StarWarEntity


function StarWarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StarWarEntity)
  self._name = "star_war"
  self._client = client
...
function StarWarEntity:get_name()
  return self._name
end


function StarWarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return StarWarEntity.new(self._client, opts)
end
...
function StarWarEntity:mark_deleted()
  self._deleted = true
end


function StarWarEntity:deleted()
  return true == self._deleted
end


function StarWarEntity:data_set(args)
  if args ~= nil then
...
function StarWarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StarWarEntity:match_set(args)
  if args ~= nil then
...
function StarWarEntity:match_get()
...
function StarWarEntity:stream(action, args, callopts)
...
---@param reqmatch StarWarLoadMatch
---@param ctrl? table
---@return StarWar
---@return string? err
function StarWarEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function StarWarEntity:_run_op(ctx, post_done)
  local utility = self._utility
