...
AQL-driven CLI and REPL for the McuCountdown SDK. Positional arguments are
...
./mcu-countdown-cli list api
./mcu-countdown-cli load 1 api
./mcu-countdown-cli load '{id:1}' api
