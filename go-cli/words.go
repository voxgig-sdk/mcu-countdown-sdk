...
func registerSDKWords(r *eng.Registry, client *sdk.McuCountdownSDK) {
...
func runOp(client *sdk.McuCountdownSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
