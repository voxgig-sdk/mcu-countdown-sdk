...
class McuCountdownTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = McuCountdownTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = McuCountdownTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = McuCountdownTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
