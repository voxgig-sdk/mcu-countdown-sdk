...
// McuCountdown SDK telemetry feature
...
class McuCountdownTelemetryFeature extends McuCountdownBaseFeature
{
    ...
    private function _close(McuCountdownContext $ctx, bool $ok): void
    {
