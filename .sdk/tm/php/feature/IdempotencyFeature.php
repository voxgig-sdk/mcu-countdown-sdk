...
// McuCountdown SDK idempotency feature
...
class McuCountdownIdempotencyFeature extends McuCountdownBaseFeature
{
    ...
    private function _mutating(McuCountdownContext $ctx): bool
    {
