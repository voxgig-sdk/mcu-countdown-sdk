...
// McuCountdown SDK audit feature
...
class McuCountdownAuditFeature extends McuCountdownBaseFeature
{
    ...
    private function _emit(McuCountdownContext $ctx, string $outcome): void
    {
