...
// McuCountdown SDK streaming feature
...
class McuCountdownStreamingFeature extends McuCountdownBaseFeature
{
    ...
    private function _iterate(McuCountdownResult $result): \Generator
    {
    ...
    private function _streamable(McuCountdownContext $ctx): bool
    {
