...
// McuCountdown SDK utility: graphql
//
...
class McuCountdownGraphql
{
    ...
    // equivalent.
    public static function body(McuCountdownContext $ctx): mixed
    {
    ...
    public static function errors(McuCountdownContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
