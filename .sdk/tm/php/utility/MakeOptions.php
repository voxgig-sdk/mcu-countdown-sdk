...
// McuCountdown SDK utility: make_options

class McuCountdownMakeOptions
{
    ...
    public static function call(McuCountdownContext $ctx): array
    {
        ...
        //
        // `McuCountdownSchema::optspec()` is built from the model:
        ...
        $optspec = McuCountdownSchema::optspec();
