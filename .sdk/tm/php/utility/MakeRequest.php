...
// McuCountdown SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class McuCountdownMakeRequest
{
    public static function call(McuCountdownContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new McuCountdownResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new McuCountdownResponse($fetched);
        } else {
