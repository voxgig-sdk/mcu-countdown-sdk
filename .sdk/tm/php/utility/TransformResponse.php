...
// McuCountdown SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class McuCountdownTransformResponse
{
    public static function call(McuCountdownContext $ctx): mixed
    {
        ...
        $transform = McuCountdownHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
