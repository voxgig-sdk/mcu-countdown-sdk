...
// McuCountdown SDK utility type

class McuCountdownUtility
{
    ...
    public static function copy(McuCountdownUtility $src): McuCountdownUtility
    {
        $u = new McuCountdownUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
