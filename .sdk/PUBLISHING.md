...
|---|---|---|
| `ts/` | @voxgig-sdk/mcu-countdown-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mcu-countdown-sdk \
      --repository voxgig-sdk/mcu-countdown-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mcu-countdown-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mcu-countdown-sdk --id=<id>` removes it.
