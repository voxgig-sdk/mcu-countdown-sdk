...
#      offline in seeded test mode (McuCountdownSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "McuCountdown_sdk.rb")
  SDK_CLASS = "McuCountdownSDK"
