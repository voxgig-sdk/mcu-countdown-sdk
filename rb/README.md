# McuCountdown Ruby SDK



The Ruby SDK for the McuCountdown API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `McuCountdownError` (a `StandardError` subclass), so wrap
...
```
rb/
├── McuCountdown_sdk.rb       -- Main SDK module
