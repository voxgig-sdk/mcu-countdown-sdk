...
class BatmanEntity
  ...
  # @return [Batman, Hash] the current Batman data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Batman fields)
  def match_get
  ...
  #
  # @param reqmatch [BatmanLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Batman.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Batman, Hash] the loaded Batman; raises McuCountdownError on failure
