...
from mcucountdown_sdk.core.control import McuCountdownControl
...
from mcucountdown_sdk.core.helpers import get_ctx_prop, to_map
...
class McuCountdownContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, McuCountdownSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, McuCountdownResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, McuCountdownResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return McuCountdownError(code, msg, self)
