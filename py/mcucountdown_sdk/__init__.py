...
from mcucountdown_sdk.utility import register

# Load features
from mcucountdown_sdk.feature.base_feature import McuCountdownBaseFeature
from mcucountdown_sdk.features import _has_feature, _make_feature
...
class McuCountdownSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = McuCountdownUtility()
        self._utility = utility

        from mcucountdown_sdk.config import shared_config
    ...
    def get_utility(self):
        return McuCountdownUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("McuCountdownSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def StarWar(self, data=None) -> "StarWarEntity":
        ...
        from mcucountdown_sdk.entity.star_war_entity import StarWarEntity
