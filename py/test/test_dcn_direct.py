...
class TestDcnDirect:
    ...
    def test_should_direct_load_dcn(self):
        setup = _dcn_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-dcn", "live" if setup["live"] else "unit")
        if _skip:
