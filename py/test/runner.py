...
class McuCountdownTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = McuCountdownTestRunner.getenv("MCUCOUNTDOWN_TEST_LIVE")
        override = McuCountdownTestRunner.getenv("MCUCOUNTDOWN_TEST_OVERRIDE")
        ...
        explain = McuCountdownTestRunner.getenv("MCUCOUNTDOWN_TEST_EXPLAIN")
