...
class McuCountdownTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = McuCountdownTestRunner.getenv("MCU_COUNTDOWN_TEST_LIVE")
        override = McuCountdownTestRunner.getenv("MCU_COUNTDOWN_TEST_OVERRIDE")
        ...
        explain = McuCountdownTestRunner.getenv("MCU_COUNTDOWN_TEST_EXPLAIN")
...
def entity_data(v):
    return McuCountdownTestRunner.entity_data(v)
...
def live_client_options():
    return McuCountdownTestRunner.live_client_options()
