# McuCountdown SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions McuCountdownSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both McuCountdownSDK(...) and McuCountdownSDK.test(...) become
#      McuCountdownSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mcucountdown_sdk"
_SDK_CLASS = "McuCountdownSDK"
